...
\maketitle
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            Die nächste Eingangsvariable ist $x_2$, die Ausgangsvariable $x_0$. Das entstehende Tableau ist:
            \begin{align*}
            \begin{alignedat}{6}
            && x_2 &\ = &\  \frac{13}{9} &\ + &\ \frac{8}{10}x_5 &\ + &\ \frac{1}{10}x_4 &\ - &\ \frac{9}{10}x_0 \\
            && x_1 &\ = &\  \frac{7}{10} &\ + &\  \frac{1}{5}x_5 &\ - &\ \frac{1}{10}x_4 &\ + &\             x_0 \\
            && x_3 &\ = &\  \frac{42}{5} &\ - &\  \frac{3}{5}x_5 &\ - &\ \frac{1}{10}x_4 &\ + &\  \frac{9}{5}x_0 \\
            &\rlap{\rule{5.5cm}{.1pt}} &&&&&&&&&\\
            && w   &\ = & & & & & &\ - &\ x_0
            \end{alignedat}
            \end{align*}
            ...
            \begin{align*}
            \begin{alignedat}{6}
            && x_2 &\ = &\ \frac{13}{9} &\ + &\ \frac{8}{10}x_5 &\ + &\ \frac{1}{10}x_4 \\
            && x_1 &\ = &\ \frac{7}{10} &\ + &\  \frac{1}{5}x_5 &\ - &\ \frac{1}{10}x_4 \\
            && x_3 &\ = &\ \frac{42}{5} &\ - &\  \frac{3}{5}x_5 &\ - &\ \frac{1}{10}x_4 \\
            &\rlap{\rule{4.5cm}{.1pt}} &&&&&&&\\
