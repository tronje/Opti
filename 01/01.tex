        ...
        \item[\textbf{1.}]
            \begin{enumerate}
                ...
                \item[b)]
                    ...
                    \begin{tikzpicture}
                        %\path[fill = gray!30] (0,0)--(0,3)--(9/4,15/4)--(18/5,6-18/5)--(2,0)--cycle;
                        \begin{axis}[
                            ymin = 0,ymax = 8.5,
                            xmin = 0,xmax = 8.5,
                            x = 1cm, y = 1cm,
                            ...
                            \addplot[name path=a,domain=0:8, very thick, no marks, black!50] {(7/2)*x - 7}; \addlegendentry{NB 1};
                            \addplot[name path=b,domain=0:8, very thick, no marks, blue!50] {(2/3)*x + (5/3)}; \addlegendentry{NB 2};
                            \addplot[domain=0:8, very thick, no marks, red!50] {-x +7}; \addlegendentry{NB 3};
                            \addplot[domain=0:8, very thick, no marks, black, dotted] {-(5/3) * x + 26.5/3}; \addlegendentry{Lösungsgerade}
                            % \addplot[domain=0:8, very thick, no marks, black, dotted] {-2/5 * x + 93/20 };
                    ...
                    \end{tikzpicture}
                    \\
                    Die optimale Lösung ist also bei $x_1 = \frac{52}{17}$ und $x_2 = \frac{63}{17}$
